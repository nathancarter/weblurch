...
(function() {
  ...
  $(function() {
    ...
    return tinymce.init({
      ...
      plugins: 'advlist table charmap colorpicker image link paste print searchreplace textcolor fullscreen -loadsave -overlay -groups -equationeditor -dependencies -dialogs ' + ((function() {
