...
(function() {
  ...
  tinymce.PluginManager.add('overlay', function(editor, url) {
    ...
    return editor.Overlay.addDrawHandler(function(canvas, context) {
      context.beginPath();
  ...
  $(function() {
    ...
    return tinymce.init({
      ...
      statusbar: false,
      plugins: 'advlist table charmap colorpicker contextmenu image link importcss paste print save searchreplace textcolor fullscreen -loadsave -overlay',
