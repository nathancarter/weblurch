...
(function() {
  var Dependencies, Dialogs, Group, Groups, LoadSave, Overlay, createFontStyleString, createStyleString, editor, embedMetadata, exportPage, extractMetadata, formatContentForWiki, getAPIPage, getIndexPage, getPageContent, getPageData, getPageMetadata, getPageTimestamp, grouperHTML, grouperInfo, htmlToImage, importPage, login, maybeSetupTestRecorder, moreMenuItems, moreToolbarItems, plugin, setAPIPage, setIndexPage,
  ...
  $(function() {
    ...
    return tinymce.init({
      ...
      plugins: 'advlist table charmap colorpicker image link importcss paste print save searchreplace textcolor fullscreen -loadsave -overlay -groups -equationeditor -dependencies ' + ((function() {
