...
generated by the `menu` function [defined below](#menus).
...
The following function computes the contents of the context menu and/or tag
menu for a given group.

    menu = ( group ) ->
        result = [ ]
        window.addDocumentationMenuItem group, result
        # Later there will be other menu items also; I'm planning ahead.
        result
