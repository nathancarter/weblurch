...
(function() {
  var testState, update, waitingForMainApplication, waitingStorage;
  ...
  window.enterReadyState = function() {
    ...
    for (_i = 0, _len = waitingStorage.length; _i < _len; _i++) {
      ...
      _results.push(document.body.appendChild(node));
    }
    return _results;
  };
  ...
  update = function() {
    var args, ary, code, count, escapeApos, explanation, indent, index, step, string, title, writeStep, _i, _len;
    code = '';
    ...
    return document.getElementById('testCode').textContent = code;
  };
