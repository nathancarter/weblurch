...
This pane shows the interpretation of the document as code.

 * It will have a drop-down element at the top that lets you choose the
   programming language in which the contents of the pane will be expressed.
   Changing that language (or anything in the document) will cause the
   contents of the right pane to be regenerated.
