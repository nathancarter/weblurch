...
(function() {
  ...
  window.setupCommonCommands = function() {
    var button, code, commonCommands, desc, glyphIcon, title, triple, _fn, _i, _len, _results;
    ...
    _results = [];
    for (_i = 0, _len = commonCommands.length; _i < _len; _i++) {
      triple = commonCommands[_i];
      title = triple[0], desc = triple[1], code = triple[2];
      ...
      _fn(code);
      _results.push(window.commonCommands.appendChild(document.createTextNode(' ')));
    }
    return _results;
  };
